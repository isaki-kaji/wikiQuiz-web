...
const CategoryCard: React.FC<CategoryCardProps> = ({ title, Icon }) => {
  return (
    <div className="border-[1px] rounded-lg cursor-pointer transition duration-300 ease-in-out hover:shadow-lg dark:hover:shadow-black/30">
      <div className="flex flex-col gap-2 h-full justify-center items-center px-2 py-4 sm:px-6 sm:py-16">
        <div className="w-[120px] sm:w-[250px] flex justify-center">
